...
public class GLRoundedGeometry {
    ...
    public GeometryArrays generateVertexData( RectF radii,  RectF viewPortGLBounds,
     ...
     */
    private void addRect( GeometryArrays geoArrays,
                          float[][] rectPoints,
                          RectF viewPort,
                         float z) {
     ...
     * @param z the z coordinate.
     */
    private void addRoundedCorner( GeometryArrays geoArrays,
                                   float[] center,
                                  float[] radius,
                                  float rads0,
                                  float rads1,
